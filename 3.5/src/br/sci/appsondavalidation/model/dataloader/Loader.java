		...
		try (PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(output)))) {
			for (int i= 0; i< data.length; i++) {
				...
				if ((data[i][4] == 3333) || (data[i][4] == -6999))
					...
					out.printf("%.0f;", data[i][4]);
				else
					out.printf(Locale.US, "%5.3f;", data[i][4]);
				...
				if ((data[i][28] == 3333) || (data[i][28] == -6999))
					...
					out.printf("%.0f;", data[i][28]);
				else
					out.printf(Locale.US, "%5.3f;", data[i][28]);
				...
				if ((data[i][8] == 3333) || (data[i][8] == -6999))
					...
					out.printf("%.0f;", data[i][8]);
				else
					out.printf(Locale.US, "%5.3f;", data[i][8]);
				...
				if ((data[i][12] == 3333) || (data[i][12] == -6999))
					...
					out.printf("%.0f;", data[i][12]);
				else
					out.printf(Locale.US, "%5.3f;", data[i][12]);
				...
				if ((data[i][16] == 3333) || (data[i][16] == -6999))
					...
					out.printf("%.0f;", data[i][16]);
				else
					out.printf(Locale.US, "%5.3f;", data[i][16]);
				
				// Print Air Temperature AVG 60s
				if ((data[i][20] == 3333) || (data[i][20] == -6999))
					out.print("N/A;");
				else if (data[i][20] == -5555)
					out.print("N/S;");
				else if (data[i][20] == 0)
					out.printf("%.0f;", data[i][20]);
				else
					out.printf(Locale.US, "%5.2f;", data[i][20]);
				
				// Print Relative Humidity AVG 60s
				if ((data[i][21] == 3333) || (data[i][21] == -6999))
					out.print("N/A;");
				else if (data[i][21] == -5555)
					out.print("N/S;");
				else if (data[i][21] == 0)
					out.printf("%.0f;", data[i][21]);
				else
					out.printf(Locale.US, "%5.2f;", data[i][21]);
				
				// Print Atmospheric Pressure AVG 60s
				if ((data[i][22] == 3333) || (data[i][22] == -6999))
					out.print("N/A;");
				else if (data[i][22] == -5555)
					out.print("N/S;");
				else if (data[i][22] == 0)
					out.printf("%.0f;", data[i][22]);
				else
					out.printf(Locale.US, "%5.2f;", data[i][22]);
				...
				if (data[i][23] == 3333)
					...
					out.printf("%.0f;", data[i][23]);
				else
					out.printf(Locale.US, "%.1f;", data[i][23]);
				
				// Print Wind Speed AVG 60s
				if ((data[i][24] == 3333) || (data[i][24] == -6999))
					out.print("N/A;");
				else if (data[i][24] == -5555)
					out.print("N/S;");
				else if (data[i][24] == 0)
					out.printf("%.0f;", data[i][24]);
				else
					out.printf(Locale.US, "%5.3f;", data[i][24]);
				
				// Print Wind Direction AVG 60s
				if ((data[i][25] == 3333) || (data[i][25] == -6999))
					out.print("N/A\n");
